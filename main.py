...
import sys
os.system(f'{sys.executable} ./depth/depth_simple.py --checkpoint_path "{model_path}" --image_path "{img_path}"')
os.system(f'{sys.executable} ./defocus/defocus.py --image_path "{img_path}" --blur_method {blur_method}')
